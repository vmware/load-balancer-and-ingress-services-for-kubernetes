...
import (
	...
	"ako/pkg/client/clientset/versioned/scheme"
...
func NewForConfig(c *rest.Config) (*AkoV1alpha1Client, error) {
	...
	return &AkoV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new AkoV1alpha1Client for the given config and
