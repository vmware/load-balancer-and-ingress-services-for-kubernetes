...
// List lists all HostRules in the indexer.
func (s *hostRuleLister) List(selector labels.Selector) (ret []*v1alpha1.HostRule, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.HostRule))
	})
	return ret, err
}
...
// List lists all HostRules in the indexer for a given namespace.
func (s hostRuleNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.HostRule, err error) {
...
// Get retrieves the HostRule from the indexer for a given namespace and name.
func (s hostRuleNamespaceLister) Get(name string) (*v1alpha1.HostRule, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("hostrule"), name)
	}
	return obj.(*v1alpha1.HostRule), nil
}
