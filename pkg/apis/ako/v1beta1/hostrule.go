...
type HostRuleVirtualHost struct {
	...
	NetworkSecurityPolicy HostRuleNetworkSecurityPolicy `json:"networkSecurityPolicy,omitempty"`
}
...
type HostRuleNetworkSecurityPolicy struct {
	Name string                             `json:"name,omitempty"`
	Type HostRuleNetworkSecurityProfileType `json:"type,omitempty"`
}

type HostRuleNetworkSecurityProfileType string

const (
	HostRuleProfileTypeAviReference    HostRuleNetworkSecurityProfileType = "ref"
	HostRuleProfileTypeCustomReference HostRuleNetworkSecurityProfileType = "custom"
)
