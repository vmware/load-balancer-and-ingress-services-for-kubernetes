...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPSMonitor) DeepCopyInto(out *HTTPSMonitor) {
	*out = *in
	in.HTTPMonitor.DeepCopyInto(&out.HTTPMonitor)
	out.SSLAttributes = in.SSLAttributes
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPSMonitor.
func (in *HTTPSMonitor) DeepCopy() *HTTPSMonitor {
	if in == nil {
		return nil
	}
	out := new(HTTPSMonitor)
	in.DeepCopyInto(out)
	return out
}
