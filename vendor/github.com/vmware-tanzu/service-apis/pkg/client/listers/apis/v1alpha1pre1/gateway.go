...
type GatewayLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1pre1.Gateway, err error)
...
// List lists all Gateways in the indexer.
func (s *gatewayLister) List(selector labels.Selector) (ret []*v1alpha1pre1.Gateway, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1pre1.Gateway))
	})
	return ret, err
}
...
type GatewayNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1alpha1pre1.Gateway, error)
...
// List lists all Gateways in the indexer for a given namespace.
func (s gatewayNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1pre1.Gateway, err error) {
...
// Get retrieves the Gateway from the indexer for a given namespace and name.
func (s gatewayNamespaceLister) Get(name string) (*v1alpha1pre1.Gateway, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1pre1.Resource("gateway"), name)
	}
	return obj.(*v1alpha1pre1.Gateway), nil
}
