...
type GatewayInterface interface {
	Create(*v1alpha1pre1.Gateway) (*v1alpha1pre1.Gateway, error)
	Update(*v1alpha1pre1.Gateway) (*v1alpha1pre1.Gateway, error)
	UpdateStatus(*v1alpha1pre1.Gateway) (*v1alpha1pre1.Gateway, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1pre1.Gateway, error)
	List(opts v1.ListOptions) (*v1alpha1pre1.GatewayList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1pre1.Gateway, err error)
	GatewayExpansion
}
...
func newGateways(c *NetworkingV1alpha1pre1Client, namespace string) *gateways {
	return &gateways{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *gateways) Get(name string, options v1.GetOptions) (result *v1alpha1pre1.Gateway, err error) {
	result = &v1alpha1pre1.Gateway{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("gateways").
		Name(name).
...
func (c *gateways) List(opts v1.ListOptions) (result *v1alpha1pre1.GatewayList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1pre1.GatewayList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("gateways").
...
func (c *gateways) Create(gateway *v1alpha1pre1.Gateway) (result *v1alpha1pre1.Gateway, err error) {
	result = &v1alpha1pre1.Gateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("gateways").
...
func (c *gateways) Update(gateway *v1alpha1pre1.Gateway) (result *v1alpha1pre1.Gateway, err error) {
	result = &v1alpha1pre1.Gateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gateways").
...
func (c *gateways) UpdateStatus(gateway *v1alpha1pre1.Gateway) (result *v1alpha1pre1.Gateway, err error) {
	result = &v1alpha1pre1.Gateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gateways").
...
func (c *gateways) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1pre1.Gateway, err error) {
	result = &v1alpha1pre1.Gateway{}
