...
type SETimeTrackerProperties struct {
	...
	EgressThreshold *int32 `json:"egress_threshold,omitempty"`
	...
	EventGenWindow *int64 `json:"event_gen_window,omitempty"`
	...
	IngressThreshold *int32 `json:"ingress_threshold,omitempty"`
}
