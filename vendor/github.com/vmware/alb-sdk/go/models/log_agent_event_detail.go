...
type LogAgentEventDetail struct {
	...
	// Event for TCP connection restablishment rate exceeds configured threshold. Field introduced in 23.1.1. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
