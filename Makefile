...
gatewayapi_infrasettingtests:
	...
	-coverprofile cover-23.out -coverpkg=./ako-gateway-api/...  > gatewayapi_infrasettingtests.log 2>&1 && echo "gatewayapi_infrasettingtests passed") || (echo "gatewayapi_infrasettingtests failed" && cat gatewayapi_infrasettingtests.log && exit 1)
...
gatewayapi_multitenancytests:
	...
	-coverprofile cover-23.out -coverpkg=./ako-gateway-api/...  > gatewayapi_multitenancytests.log 2>&1 && echo "gatewayapi_multitenancytests passed") || (echo "gatewayapi_multitenancytests failed" && cat gatewayapi_multitenancytests.log && exit 1)
