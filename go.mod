module gitlab.eng.vmware.com/orion/akc
...
require (
	...
	gitlab.eng.vmware.com/orion/container-lib v0.0.0-20200116061816-75a6f0d69556
	...
	k8s.io/apimachinery v0.0.0-20190807091453-5477731e3db2
