...
func TestAdvL4WithHealthMonitorCRDRef(t *testing.T) {
	...
	// STEP 2: Setup L4Rule with HealthMonitorCRDRef
	_, err := dynamicClient.Resource(lib.HealthMonitorGVR).Namespace(ns).Create(context.TODO(), healthMonitor1, metav1.CreateOptions{})
	if err != nil {
	...
	if err := dynamicClient.Resource(lib.HealthMonitorGVR).Namespace(ns).Delete(context.TODO(), healthMonitorName, metav1.DeleteOptions{}); err != nil {
