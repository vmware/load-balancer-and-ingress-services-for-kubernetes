...
func SetupL7Rule(t *testing.T, name string, g *gomega.WithT) {
	l7rule := FakeL7Rule{
		...
		AnalyticsProfile:              getKindName("analyticsprofile", "thisisaviref-analyticsprofile-l7"),
		ApplicationProfile:            getKindName("appprofile", "thisisaviref-appprofile-l7"),
		WafPolicy:                     getKindName("wafpolicy", "thisisaviref-wafpolicy-l7"),
		IcapProfile:                   getKindName("icaprofile", "thisisaviref-icaprofile-l7"),
		ErrorPageProfile:              getKindName("errorpageprofile", "thisisaviref-errorpageprofile-l7"),
		HTTPPolicy: &akov1alpha2.L7RuleHTTPPolicy{
