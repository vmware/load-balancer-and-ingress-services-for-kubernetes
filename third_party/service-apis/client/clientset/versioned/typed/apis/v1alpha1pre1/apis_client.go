...
func (c *NetworkingV1alpha1pre1Client) GatewayClasses() GatewayClassInterface {
...
func NewForConfig(c *rest.Config) (*NetworkingV1alpha1pre1Client, error) {
	...
	return &NetworkingV1alpha1pre1Client{client}, nil
}

// NewForConfigOrDie creates a new NetworkingV1alpha1pre1Client for the given config and
...
func New(c rest.Interface) *NetworkingV1alpha1pre1Client {
	return &NetworkingV1alpha1pre1Client{c}
}

func setConfigDefaults(config *rest.Config) error {
	gv := v1alpha1pre1.SchemeGroupVersion
...
func (c *NetworkingV1alpha1pre1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
