...
type Interface interface {
	// V1alpha1pre1 provides access to shared informers for resources in V1alpha1pre1.
	V1alpha1pre1() v1alpha1pre1.Interface
}
...
// V1alpha1pre1 returns a new v1alpha1pre1.Interface.
func (g *group) V1alpha1pre1() v1alpha1pre1.Interface {
	return v1alpha1pre1.New(g.factory, g.namespace, g.tweakListOptions)
}
