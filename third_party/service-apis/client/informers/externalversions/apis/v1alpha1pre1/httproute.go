...
type HTTPRouteInformer interface {
	...
	Lister() v1alpha1pre1.HTTPRouteLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkingV1alpha1pre1().HTTPRoutes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkingV1alpha1pre1().HTTPRoutes(namespace).Watch(context.TODO(), options)
			},
		},
		&apisv1alpha1pre1.HTTPRoute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *hTTPRouteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisv1alpha1pre1.HTTPRoute{}, f.defaultInformer)
}

func (f *hTTPRouteInformer) Lister() v1alpha1pre1.HTTPRouteLister {
	return v1alpha1pre1.NewHTTPRouteLister(f.Informer().GetIndexer())
}
