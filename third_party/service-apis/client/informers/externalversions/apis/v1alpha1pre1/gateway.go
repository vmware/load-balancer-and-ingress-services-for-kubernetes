...
type GatewayInformer interface {
	...
	Lister() v1alpha1pre1.GatewayLister
}
...
func (f *gatewayInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisv1alpha1pre1.Gateway{}, f.defaultInformer)
}

func (f *gatewayInformer) Lister() v1alpha1pre1.GatewayLister {
	return v1alpha1pre1.NewGatewayLister(f.Informer().GetIndexer())
}
