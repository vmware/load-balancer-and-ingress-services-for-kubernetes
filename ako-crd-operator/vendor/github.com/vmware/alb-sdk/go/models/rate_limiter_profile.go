...
type RateLimiterProfile struct {
	...
	// Rate Limit all connections made from any single client IP address to the Virtual Service. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Rate Limit all HTTP requests from any single client IP address to all URLs of the Virtual Service. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Rate Limit all HTTP requests from any single client IP address to any single URL. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	ClientIPToURIRequestsRateLimit *RateProfile `json:"client_ip_to_uri_requests_rate_limit,omitempty"`

	// Rate Limit all HTTP requests that map to any custom string. Field introduced in 17.2.13,18.1.3,18.2.1. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Rate Limit all HTTP requests from all client IP addresses to any single URL. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
