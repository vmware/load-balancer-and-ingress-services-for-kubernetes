...
type GatewayClassInformer interface {
	...
	Lister() v1alpha1pre1.GatewayClassLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkingV1alpha1pre1().GatewayClasses().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkingV1alpha1pre1().GatewayClasses().Watch(context.TODO(), options)
			},
		},
		&apisv1alpha1pre1.GatewayClass{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *gatewayClassInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisv1alpha1pre1.GatewayClass{}, f.defaultInformer)
}

func (f *gatewayClassInformer) Lister() v1alpha1pre1.GatewayClassLister {
	return v1alpha1pre1.NewGatewayClassLister(f.Informer().GetIndexer())
}
