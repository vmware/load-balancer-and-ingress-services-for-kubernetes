...
func (c *hTTPRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1pre1.HTTPRoute, err error) {
...
func (c *hTTPRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1pre1.HTTPRouteList, err error) {
...
func (c *hTTPRoutes) Create(ctx context.Context, hTTPRoute *v1alpha1pre1.HTTPRoute, opts v1.CreateOptions) (result *v1alpha1pre1.HTTPRoute, err error) {
	result = &v1alpha1pre1.HTTPRoute{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("httproutes").
...
func (c *hTTPRoutes) Update(ctx context.Context, hTTPRoute *v1alpha1pre1.HTTPRoute, opts v1.UpdateOptions) (result *v1alpha1pre1.HTTPRoute, err error) {
	result = &v1alpha1pre1.HTTPRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("httproutes").
...
func (c *hTTPRoutes) UpdateStatus(ctx context.Context, hTTPRoute *v1alpha1pre1.HTTPRoute, opts v1.UpdateOptions) (result *v1alpha1pre1.HTTPRoute, err error) {
	result = &v1alpha1pre1.HTTPRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("httproutes").
...
func (c *hTTPRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1pre1.HTTPRoute, err error) {
	result = &v1alpha1pre1.HTTPRoute{}
