...
func (c *tCPRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1pre1.TCPRoute, err error) {
...
func (c *tCPRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1pre1.TCPRouteList, err error) {
...
func (c *tCPRoutes) Create(ctx context.Context, tCPRoute *v1alpha1pre1.TCPRoute, opts v1.CreateOptions) (result *v1alpha1pre1.TCPRoute, err error) {
	result = &v1alpha1pre1.TCPRoute{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tcproutes").
...
func (c *tCPRoutes) Update(ctx context.Context, tCPRoute *v1alpha1pre1.TCPRoute, opts v1.UpdateOptions) (result *v1alpha1pre1.TCPRoute, err error) {
	result = &v1alpha1pre1.TCPRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tcproutes").
...
func (c *tCPRoutes) UpdateStatus(ctx context.Context, tCPRoute *v1alpha1pre1.TCPRoute, opts v1.UpdateOptions) (result *v1alpha1pre1.TCPRoute, err error) {
	result = &v1alpha1pre1.TCPRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tcproutes").
...
func (c *tCPRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1pre1.TCPRoute, err error) {
	result = &v1alpha1pre1.TCPRoute{}
