	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AkoV1alpha1().MultiClusterIngresses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AkoV1alpha1().MultiClusterIngresses(namespace).Watch(context.TODO(), options)
			},
		},
		&akov1alpha1.MultiClusterIngress{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *multiClusterIngressInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&akov1alpha1.MultiClusterIngress{}, f.defaultInformer)
}
