...
func (c *gateways) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1pre1.Gateway, err error) {
...
func (c *gateways) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1pre1.GatewayList, err error) {
...
func (c *gateways) Create(ctx context.Context, gateway *v1alpha1pre1.Gateway, opts v1.CreateOptions) (result *v1alpha1pre1.Gateway, err error) {
	result = &v1alpha1pre1.Gateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("gateways").
...
func (c *gateways) Update(ctx context.Context, gateway *v1alpha1pre1.Gateway, opts v1.UpdateOptions) (result *v1alpha1pre1.Gateway, err error) {
	result = &v1alpha1pre1.Gateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gateways").
...
func (c *gateways) UpdateStatus(ctx context.Context, gateway *v1alpha1pre1.Gateway, opts v1.UpdateOptions) (result *v1alpha1pre1.Gateway, err error) {
	result = &v1alpha1pre1.Gateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gateways").
...
func (c *gateways) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1pre1.Gateway, err error) {
	result = &v1alpha1pre1.Gateway{}
