...
func (c *gatewayClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1pre1.GatewayClass, err error) {
...
func (c *gatewayClasses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1pre1.GatewayClassList, err error) {
...
func (c *gatewayClasses) Create(ctx context.Context, gatewayClass *v1alpha1pre1.GatewayClass, opts v1.CreateOptions) (result *v1alpha1pre1.GatewayClass, err error) {
	result = &v1alpha1pre1.GatewayClass{}
	err = c.client.Post().
		Resource("gatewayclasses").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *gatewayClasses) Update(ctx context.Context, gatewayClass *v1alpha1pre1.GatewayClass, opts v1.UpdateOptions) (result *v1alpha1pre1.GatewayClass, err error) {
	result = &v1alpha1pre1.GatewayClass{}
	err = c.client.Put().
		Resource("gatewayclasses").
...
func (c *gatewayClasses) UpdateStatus(ctx context.Context, gatewayClass *v1alpha1pre1.GatewayClass, opts v1.UpdateOptions) (result *v1alpha1pre1.GatewayClass, err error) {
	result = &v1alpha1pre1.GatewayClass{}
	err = c.client.Put().
		Resource("gatewayclasses").
		Name(gatewayClass.Name).
...
func (c *gatewayClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1pre1.GatewayClass, err error) {
	result = &v1alpha1pre1.GatewayClass{}
