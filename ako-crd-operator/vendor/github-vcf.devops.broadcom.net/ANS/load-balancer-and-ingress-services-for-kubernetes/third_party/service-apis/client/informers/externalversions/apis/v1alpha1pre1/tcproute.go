...
type TCPRouteInformer interface {
	...
	Lister() v1alpha1pre1.TCPRouteLister
}
...
func (f *tCPRouteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisv1alpha1pre1.TCPRoute{}, f.defaultInformer)
}

func (f *tCPRouteInformer) Lister() v1alpha1pre1.TCPRouteLister {
	return v1alpha1pre1.NewTCPRouteLister(f.Informer().GetIndexer())
}
