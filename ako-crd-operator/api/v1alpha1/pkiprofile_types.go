...
type PKIProfileSpec struct {
	...
	CACertificateRefs []v1.ObjectReference `json:"ca_certificate_refs,omitempty"`
	// CrlCheck when enabled, Avi will verify via CRL checks that certificates in the trust chain have not been revoked.
	// +optional
