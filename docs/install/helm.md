...
```
helm show chart oci://projects.registry.vmware.com/ako/helm-charts/ako --version 1.10.4

Pulled: projects.registry.vmware.com/ako/helm-charts/ako:1.10.4
...
```
helm show values oci://projects.registry.vmware.com/ako/helm-charts/ako --version 1.10.4 > values.yaml
...
```
helm install --generate-name oci://projects.registry.vmware.com/ako/helm-charts/ako --version 1.10.4 -f /path/to/values.yaml  --set ControllerSettings.controllerHost=<controller IP or Hostname> --set avicredentials.username=<avi-ctrl-username> --set avicredentials.password=<avi-ctrl-password> --set AKOSettings.primaryInstance=true --namespace=avi-system
```
...
ako-1691752136	avi-system	1       	2023-08-11	deployed	ako-1.10.4	1.10.4
```
...
```
helm template oci://projects.registry.vmware.com/ako/helm-charts/ako --version 1.10.4 --include-crds --output-dir <output_dir>
```
...
Get the values.yaml for the AKO version 1.10.4 and edit the values as per the requirement.
...
```
helm upgrade ako-1593523840  oci://projects.registry.vmware.com/ako/helm-charts/ako -f /path/to/values.yaml --version 1.10.4 --set ControllerSettings.controllerHost=<IP or Hostname> --set avicredentials.password=<username> --set avicredentials.username=<username> --namespace=avi-system
