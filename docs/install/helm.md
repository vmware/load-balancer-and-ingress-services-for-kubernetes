...
```
helm show chart oci://projects.packages.broadcom.com/ako/helm-charts/ako --version 1.13.3

Pulled: projects.packages.broadcom.com/ako/helm-charts/ako:1.13.3
...
```
helm show values oci://projects.packages.broadcom.com/ako/helm-charts/ako --version 1.13.3 > values.yaml
...
```
helm install --generate-name oci://projects.packages.broadcom.com/ako/helm-charts/ako --version 1.13.3 -f /path/to/values.yaml  --set ControllerSettings.controllerHost=<controller IP or Hostname> --set avicredentials.username=<avi-ctrl-username> --set avicredentials.password=<avi-ctrl-password> --set AKOSettings.primaryInstance=true --namespace=avi-system
```
...
ako-1691752136	avi-system	1       	2025-01-31	deployed	ako-1.13.3	1.13.3
```
...
```
helm template oci://projects.packages.broadcom.com/ako/helm-charts/ako --version 1.13.3 --include-crds --output-dir <output_dir>
```
...
Get the values.yaml for the AKO version 1.13.3 and edit the values as per the requirement.
