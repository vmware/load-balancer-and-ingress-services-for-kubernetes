...
```
helm show chart oci://projects.registry.vmware.com/ako/helm-charts/ako --version 1.11.44

Pulled: projects.registry.vmware.com/ako/helm-charts/ako:1.11.44
...
```
helm show values oci://projects.registry.vmware.com/ako/helm-charts/ako --version 1.11.44 > values.yaml
...
```
helm install --generate-name oci://projects.registry.vmware.com/ako/helm-charts/ako --version 1.11.44 -f /path/to/values.yaml  --set ControllerSettings.controllerHost=<controller IP or Hostname> --set avicredentials.username=<avi-ctrl-username> --set avicredentials.password=<avi-ctrl-password> --set AKOSettings.primaryInstance=true --namespace=avi-system
```
...
ako-1691752136	avi-system	1       	2023-09-28	deployed	ako-1.11.44	1.11.44
```
...
```
helm template oci://projects.registry.vmware.com/ako/helm-charts/ako --version 1.11.44 --include-crds --output-dir <output_dir>
```
...
Get the values.yaml for the AKO version 1.11.44 and edit the values as per the requirement.
