...
```
helm show chart oci://projects.packages.broadcom.com/ako/helm-charts/ako --version 1.13.4

Pulled: projects.packages.broadcom.com/ako/helm-charts/ako:1.13.4
...
```
helm show values oci://projects.packages.broadcom.com/ako/helm-charts/ako --version 1.13.4 > values.yaml
...
```
helm install --generate-name oci://projects.packages.broadcom.com/ako/helm-charts/ako --version 1.13.4 -f /path/to/values.yaml  --set ControllerSettings.controllerHost=<controller IP or Hostname> --set avicredentials.username=<avi-ctrl-username> --set avicredentials.password=<avi-ctrl-password> --set AKOSettings.primaryInstance=true --namespace=avi-system
```
...
ako-1691752136	avi-system	1       	2025-01-31	deployed	ako-1.13.4	1.13.4
```
...
```
helm template oci://projects.packages.broadcom.com/ako/helm-charts/ako --version 1.13.4 --include-crds --output-dir <output_dir>
```
...
Get the values.yaml for the AKO version 1.13.4 and edit the values as per the requirement.
...
```
helm upgrade ako-1593523840  oci://projects.packages.broadcom.com/ako/helm-charts/ako -f /path/to/values.yaml --version 1.13.4 --set ControllerSettings.controllerHost=<IP or Hostname> --set avicredentials.password=<username> --set avicredentials.username=<username> --namespace=avi-system
