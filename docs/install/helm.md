...
| `NetworkSettings.defaultDomain` | Specify a default sub-domain for L4 LB services/L7 virtual service created from OpenShift route. | First domainname found in cloud's dnsprofile for L4 vs and `empty string` for L7 vs |
