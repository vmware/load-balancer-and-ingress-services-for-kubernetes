...
ako/ako              	1.9.3        	    1.9.3     	        A helm chart for Avi Kubernetes Operator
...
```
helm show values ako/ako --version 1.9.3 > values.yaml
...
```
helm install  ako/ako  --generate-name --version 1.9.3 -f /path/to/values.yaml  --set ControllerSettings.controllerHost=<controller IP or Hostname> --set avicredentials.username=<avi-ctrl-username> --set avicredentials.password=<avi-ctrl-password> --set AKOSettings.primaryInstance=true --namespace=avi-system
```

<b>Secondary AKO installation</b>
```
helm install  ako/ako  --generate-name --version 1.9.3 -f /path/to/values.yaml  --set ControllerSettings.controllerHost=<controller IP or Hostname> --set avicredentials.username=<avi-ctrl-username> --set avicredentials.password=<avi-ctrl-password> --set AKOSettings.primaryInstance=false --namespace=avi-system
...
```
helm template ako/ako --version 1.9.3 --include-crds --output-dir <output_dir>
```
...
```
helm upgrade ako-1593523840 ako/ako -f /path/to/values.yaml --version 1.9.3 --set ControllerSettings.controllerHost=<IP or Hostname> --set avicredentials.password=<username> --set avicredentials.username=<username> --namespace=avi-system
