...
Helm upgrade ako-1593523840 ako/ako -f /path/to/values.yaml --version 1.10.5 --set ControllerSettings.controllerHost=<IP or Hostname> --set avicredentials.password=<username> --set avicredentials.username=<username> --namespace=avi-system
