...
const (
	BackendRefFilterDatascript = `pool_name = avi.pool.name()
  	add_header_strgrp = "ako-gw-CLUSTER-AddHeaderStringGroup"
	...
	update_header_strgrp = "ako-gw-CLUSTER-UpdateHeaderStringGroup"
	...
	delete_header_strgrp = "ako-gw-CLUSTER-DeleteHeaderStringGroup"
