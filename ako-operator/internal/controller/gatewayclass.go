...
func createOrUpdateGatewayClass(ctx context.Context, ako akov1beta1.AKOConfig, log logr.Logger, r *AKOConfigReconciler) error {
	var oldGWClass gatewayv1.GatewayClass
	...
	var newGWClass gatewayv1.GatewayClass
...
func BuildGatewayClass(ako akov1beta1.AKOConfig, r *AKOConfigReconciler, log logr.Logger) gatewayv1.GatewayClass {
