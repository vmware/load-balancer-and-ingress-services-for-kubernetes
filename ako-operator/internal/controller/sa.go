...
func createOrUpdateServiceAccount(ctx context.Context, ako akov1beta1.AKOConfig, log logr.Logger, r *AKOConfigReconciler) error {
...
func BuildServiceAccount(ako akov1beta1.AKOConfig, r *AKOConfigReconciler, log logr.Logger) v1.ServiceAccount {
