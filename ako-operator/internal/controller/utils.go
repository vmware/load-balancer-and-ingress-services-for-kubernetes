...
const (
	...
	PassthroughShardSize   = "passhthroughShardSize"
	...
	FQDNReusePolicy        = "fqdnReusePolicy"
...
var ConfigMapEnvVars = map[string]string{
	...
	"FQDN_REUSE_POLICY":          FQDNReusePolicy,
	"ENDPOINTSLICES_ENABLED":     EnableEndpointSlice,
}
...
func getEnvVars(ako akov1beta1.AKOConfig, aviSecret v1.Secret) []v1.EnvVar {
...
func getEnvVarsForGateway(ako akov1beta1.AKOConfig) []v1.EnvVar {
	envVars := []v1.EnvVar{}
