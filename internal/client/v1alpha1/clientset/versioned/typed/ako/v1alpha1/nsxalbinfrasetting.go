...
type NsxAlbInfraSettingInterface interface {
	Create(ctx context.Context, nsxAlbInfraSetting *v1alpha1.NsxAlbInfraSetting, opts v1.CreateOptions) (*v1alpha1.NsxAlbInfraSetting, error)
	Update(ctx context.Context, nsxAlbInfraSetting *v1alpha1.NsxAlbInfraSetting, opts v1.UpdateOptions) (*v1alpha1.NsxAlbInfraSetting, error)
	UpdateStatus(ctx context.Context, nsxAlbInfraSetting *v1alpha1.NsxAlbInfraSetting, opts v1.UpdateOptions) (*v1alpha1.NsxAlbInfraSetting, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.NsxAlbInfraSetting, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.NsxAlbInfraSettingList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NsxAlbInfraSetting, err error)
	NsxAlbInfraSettingExpansion
}
...
func (c *nsxAlbInfraSettings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NsxAlbInfraSettingList, err error) {
...
func (c *nsxAlbInfraSettings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *nsxAlbInfraSettings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
